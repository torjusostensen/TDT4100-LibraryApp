...
public class LibraryController {
    ...
    //TODO must fix removing book from inventory
    ...
    private void initializeAvailableBooks() {
        ...
        library.addBookToLibrary(new Book("EBook", "W.Charles", 3, 1));
        library.addBookToLibrary(new Book("EBook two", "W.Charles", 3, 1));
        library.addBookToLibrary(new Book("Book", "W.Charles", 3, 1));
    ...
    private void readConfirmation() {
        try {
            ...
            // yourChart.getItems().add(bookingConfirmation.readFile("src/main/java/Library/confirmation.txt"));
