...
public class Library {
    ...
    public void writeConfirmationLoanOfBooks(ReadAndWrite bookingConfirmation, Library library) throws IOException {
        bookingConfirmation.writeFile("confirmation.txt", library);
    }

    public void getConfirmationLoanOfBooks(ReadAndWrite bookingConfirmation) throws IOException {
        bookingConfirmation.readFile("confirmation.txt");
    }
    ...
    public String toString() {
        ...
        result += """
                Book(s) in your chart:\040""" + borrowedBooks.size() + "\n";
        result += """
                ---------------------------------------------------
    ...
    private boolean checkReturnBooks() {
        return !borrowedBooks.isEmpty() && isUser;
    }
